...
////////////////////////////////////////////////////////////////////////////////////////////////
// The selectable is a pure abstract base class for selectable elements such as
// menu items and radio buttons and elements in a list with user selectable
// items.
////////////////////////////////////////////////////////////////////////////////////////////////
class selectable {
public:
 ...
 *
 * The selection_list is a proxy base class that manages a container subject
 * with selectable items. The selection_list manages singe or multiple
 * selections, click select, shift-click select, shift-control (command on
 * MacOS), up and down navigation also and with shift and control (command on
 * MacOS) selection extension.
 */
//==============================================================================================
class selection_list_element : public proxy_base {
public:
   using indices_type = std::vector<std::size_t>;
   using on_select_function =
       std::function<void(int select_start, int select_end)>;
 ...
 *
 * \param subject The subject of the selection list proxy. The subject is
 * expected to contain a composite. This requirement is not enforced. The
 * selection_list simply does nothing if the subject does not contain a
 * composite to work on.
 *
 * \param multi_select Determines if we allow multiple selections or not.
 * Defaults to `true`.
 */
//==============================================================================================
