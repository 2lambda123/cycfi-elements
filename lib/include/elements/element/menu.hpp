...
// Basic Dropdown Menu
////////////////////////////////////////////////////////////////////////////
enum class menu_position { top_left, top_right, bottom_left, bottom_right };
...
public:
   ...
   template <typename Menu> void menu(Menu &&menu_);
...
template <typename Menu> inline void basic_button_menu::menu(Menu &&menu_) {
...
template <typename Derived> struct basic_menu_item_element_base : proxy_base {
...
inline bool basic_menu_item_element::is_selected() const { return _selected; }

inline void basic_menu_item_element::select(bool state) { _selected = state; }
} // namespace elements
} // namespace cycfi
