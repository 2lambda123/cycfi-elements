...
namespace elements {
namespace detail {
template <typename Ptr> inline Ptr find_element_impl(element *e_) {
...
template <typename Ptr> inline Ptr find_element_impl(element const *e_) {
   if (auto *e = dynamic_cast<Ptr>(e_))
      return e;
...
////////////////////////////////////////////////////////////////////////////
template <typename Ptr> inline Ptr find_subject(element *e_) {
...
template <typename Ptr> inline Ptr find_subject(element const *e_) {
...
////////////////////////////////////////////////////////////////////////////
template <typename Ptr> inline Ptr find_element(element *e_) {
...
// to its context.
////////////////////////////////////////////////////////////////////////////
std::pair<composite_base *, context const *> inline find_composite(
    context const &ctx) {
   element *this_ = ctx.element;
   std::pair<composite_base *, context const *> result = {nullptr, nullptr};
   auto p = ctx.parent;
   while (p) {
      auto &&find = [&](context const &ctx, element *e) -> bool {
...
////////////////////////////////////////////////////////////////////////////
template <typename Ptr> inline Ptr find_parent(context const &ctx) {
   auto p = ctx.parent;
   while (p) {
